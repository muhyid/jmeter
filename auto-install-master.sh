...
JMETER_NAMESPACE=vrp-loadtesting
JMETER_APP_NAME=jmeter-master
JMETER_GIT_REPO=https://github.com/muhyid/jmeter.git
JMETER_TEST="example"
MEMORY_REQUEST="1024"
MEMORY_LIMIT="2048"
CPU_REQUEST="1.0"
...
oc process -f templates/jmeter-bc-master.yaml \
...
oc process -f templates/jmeter-dc-master.yaml \
    -p APP_NAMESPACE=$JMETER_NAMESPACE \
    -p APPLICATION_NAME=$JMETER_APP_NAME \
